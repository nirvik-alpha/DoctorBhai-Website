    ...
    return <div>
        ...
        <div className='mt-12'>
            ...
            <ul className='pt-4 md:p-5'>
                <li className='flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]'>
                    ...
                    <p className='text-[14px] leading-5 font-medium text-textColor'>New Apollo Hospital Nyc.</p>
        ...
        <div className='mt-12'>
            ...
            <ul className='grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5'>
                <li className='p-4 rounded bg-[#000435]'>
                    <span className='text-yellowColor text-[15px] leading-6 font-semibold'>
                        {formatDate('10-02-2014')}-{formatDate('12-04-2016')}
                    </span>
                    <p className='text-[16px] leading-6 font-medium text-WhiteColor'>Sr. Surgeon</p>
                    <p className='text-[14px] leading-5 font-medium text-WhiteColor'>Apollo Hospital , Nyc</p>
