                ...
                <div className='md:col-span-2'>
                    <div className='flex items-center gap-5'>
                        ...
                        <div>
                            ...
                            <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Muhibur Farhan</h3>
                            ...
                            <div className='flex items-center gap-[6px]'>
                                ...
                                leading-5 lg:text-[16px] lg:leading-7 font-[400] text-textColor'>
                                    (272)
                                </span>
                            </div>
